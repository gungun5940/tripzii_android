...
class PaymentTransferActivity : AppCompatActivity() {
    ...
    private var qrCodeTransferImageView: ImageView? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        qrCodeTransferImageView = findViewById(R.id.qrCodeTransferImageView)
        val intent = Intent()
        pickupLocationTransferTextInput?.setText(intent.getStringExtra("pickupLocationTransfer"))
        bitmap = textToImageEncode(pickupLocationTransferTextInput.toString())
        qrCodeTransferImageView!!.setImageBitmap(bitmap)
    ...
    companion object {
        var QrCodeWidth = 500
        private var IMAGE_DIRECTORY = "/QrCodeDocumentTransfer"
    }
}
