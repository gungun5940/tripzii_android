...
class PaymentTicketActivity : AppCompatActivity() {
    ...
    private var qrCodeTicketImageView: ImageView? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        qrCodeTicketImageView = findViewById(R.id.qrCodeTicketImageView)
        val intent = Intent()
        pickupLocationTicketTextInput?.setText(intent.getStringExtra("pickupLocationTicket"))
        bitmap = textToImageEncode(pickupLocationTicketTextInput.toString())
        qrCodeTicketImageView!!.setImageBitmap(bitmap)
        conFirmTicketButton.setOnClickListener {
    ...
    companion object {
        var QrCodeWidth = 500
        private var IMAGE_DIRECTORY = "/QrCodeDocumentTicket"
    }
}
